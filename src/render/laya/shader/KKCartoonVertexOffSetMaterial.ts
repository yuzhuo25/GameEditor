export default class KKCartoonVertexOffSetMaterial extends Laya.BaseMaterial {
	...
	clone(): any {
		var dest: KKCartoonVertexOffSetMaterial = new KKCartoonVertexOffSetMaterial();
		this.cloneTo(dest);
		return dest;
	}
     ...
     */
	get _MainTex() {
		return this._shaderValues.getTexture(KKCartoonVertexOffSetMaterial.ALBEDOTEXTURE);
	}
     ...
     */
	set _MainTex(value) {
		this._shaderValues.setTexture(KKCartoonVertexOffSetMaterial.ALBEDOTEXTURE, value);
	}
     ...
     */
	get _Color() {
		return this._shaderValues.getVector(KKCartoonVertexOffSetMaterial.ALBEDOCOLOR);
	}
     ...
     */
	set _Color(value) {
		this._shaderValues.setVector(KKCartoonVertexOffSetMaterial.ALBEDOCOLOR, value);
	}
 ...
 */
	get _HColor() {
		return this._shaderValues.getVector(KKCartoonVertexOffSetMaterial.HCOLOR);
	}
     ...
     */
	set _HColor(value) {
		this._shaderValues.setVector(KKCartoonVertexOffSetMaterial.HCOLOR, value);
	}
 ...
 */
	get _SColor() {
		return this._shaderValues.getVector(KKCartoonVertexOffSetMaterial.SCOLOR);
	}
     ...
     */
	set _SColor(value) {
		this._shaderValues.setVector(KKCartoonVertexOffSetMaterial.SCOLOR, value);
	}
...
*/
	get _RimColor() {
		return this._shaderValues.getVector(KKCartoonVertexOffSetMaterial.RIMCOLOR);
	}
     ...
     */
	set _RimColor(value) {
		this._shaderValues.setVector(KKCartoonVertexOffSetMaterial.RIMCOLOR, value);
	}


	get _RampThreshold() {
		return this._shaderValues.getNumber(KKCartoonVertexOffSetMaterial.RAMPTHRESHOLD);
	}
	set _RampThreshold(value) {
		this._shaderValues.setNumber(KKCartoonVertexOffSetMaterial.RAMPTHRESHOLD, value);
	}
	get _RampSmooth() {
		return this._shaderValues.getNumber(KKCartoonVertexOffSetMaterial.RAMPSMOOTH);
	}
	set _RampSmooth(value) {
		this._shaderValues.setNumber(KKCartoonVertexOffSetMaterial.RAMPSMOOTH, value);
	}

	get _RimMin() {
		return this._shaderValues.getNumber(KKCartoonVertexOffSetMaterial.RIMMIN);
	}
	set _RimMin(value) {
		this._shaderValues.setNumber(KKCartoonVertexOffSetMaterial.RIMMIN, value);
	}
	get _RimMax() {
		return this._shaderValues.getNumber(KKCartoonVertexOffSetMaterial.RIMMAX);
	}
	set _RimMax(value) {
		this._shaderValues.setNumber(KKCartoonVertexOffSetMaterial.RIMMAX, value);
	}

	get _Offset() {
		return this._shaderValues.getNumber(KKCartoonVertexOffSetMaterial.OFFSET);
	}
	set _Offset(value) {
		this._shaderValues.setNumber(KKCartoonVertexOffSetMaterial.OFFSET, value);
	}
	get _Scale() {
		return this._shaderValues.getNumber(KKCartoonVertexOffSetMaterial.SCALE);
	}
	set _Scale(value) {
		this._shaderValues.setNumber(KKCartoonVertexOffSetMaterial.SCALE, value);
	}
	...
	public static initShader(): void {
		...
		var customShader = Laya.Shader3D.add("KKCartoonVertexOffSetShader");
		var subShader = new Laya.SubShader(attributeMap, uniformMap);
		customShader.addSubShader(subShader);

		

		let pass = subShader.addShaderPass(KKCartoonVertexOffSetMaterial.vs, KKCartoonVertexOffSetMaterial.ps);
	...
	constructor() {
		super();
		if (!KKCartoonVertexOffSetMaterial._inited) {
			KKCartoonVertexOffSetMaterial.initShader();
			KKCartoonVertexOffSetMaterial._inited = true;
		}
		this.setShaderName("KKCartoonVertexOffSetShader");
		this._shaderValues.setVector(KKCartoonVertexOffSetMaterial.ALBEDOCOLOR, new Laya.Vector4(1.0, 1.0, 1.0, 1.0));
		this._shaderValues.setNumber(KKCartoonVertexOffSetMaterial.OFFSET, 0.169);
		this._shaderValues.setNumber(KKCartoonVertexOffSetMaterial.SCALE, 1.52);
