export default class KKCartoonShadowTexMaterial extends Laya.BaseMaterial {
	...
	clone(): any {
		var dest: KKCartoonShadowTexMaterial = new KKCartoonShadowTexMaterial();
		this.cloneTo(dest);
		return dest;
	}
    /**
     ...
     */
	get _MainTex() {
		return this._shaderValues.getTexture(KKCartoonShadowTexMaterial.ALBEDOTEXTURE);
	}
     ...
     */
	set _MainTex(value) {
		this._shaderValues.setTexture(KKCartoonShadowTexMaterial.ALBEDOTEXTURE, value);
	}
	/**
 * 获取阴影贴图。
 * @return 阴影贴图。
 */
	get _STexture() {
		return this._shaderValues.getTexture(KKCartoonShadowTexMaterial.SHADOWTEXTURE);
	}
     ...
     */
	set _STexture(value) {
		this._shaderValues.setTexture(KKCartoonShadowTexMaterial.SHADOWTEXTURE, value);
	}
     ...
     */
	get _Color() {
		return this._shaderValues.getVector(KKCartoonShadowTexMaterial.ALBEDOCOLOR);
	}
     ...
     */
	set _Color(value) {
		this._shaderValues.setVector(KKCartoonShadowTexMaterial.ALBEDOCOLOR, value);
	}
 ...
 */
	get _HColor() {
		return this._shaderValues.getVector(KKCartoonShadowTexMaterial.HCOLOR);
	}
     ...
     */
	set _HColor(value) {
		this._shaderValues.setVector(KKCartoonShadowTexMaterial.HCOLOR, value);
	}
 ...
 */
	get _SColor() {
		return this._shaderValues.getVector(KKCartoonShadowTexMaterial.SCOLOR);
	}
     ...
     */
	set _SColor(value) {
		this._shaderValues.setVector(KKCartoonShadowTexMaterial.SCOLOR, value);
	}
...
*/
	get _RimColor() {
		return this._shaderValues.getVector(KKCartoonShadowTexMaterial.RIMCOLOR);
	}
     ...
     */
	set _RimColor(value) {
		this._shaderValues.setVector(KKCartoonShadowTexMaterial.RIMCOLOR, value);
	}


	get _RampThreshold() {
		return this._shaderValues.getNumber(KKCartoonShadowTexMaterial.RAMPTHRESHOLD);
	}
	set _RampThreshold(value) {
		this._shaderValues.setNumber(KKCartoonShadowTexMaterial.RAMPTHRESHOLD, value);
	}
	get _RampSmooth() {
		return this._shaderValues.getNumber(KKCartoonShadowTexMaterial.RAMPSMOOTH);
	}
	set _RampSmooth(value) {
		this._shaderValues.setNumber(KKCartoonShadowTexMaterial.RAMPSMOOTH, value);
	}

	get _RimMin() {
		return this._shaderValues.getNumber(KKCartoonShadowTexMaterial.RIMMIN);
	}
	set _RimMin(value) {
		this._shaderValues.setNumber(KKCartoonShadowTexMaterial.RIMMIN, value);
	}
	get _RimMax() {
		return this._shaderValues.getNumber(KKCartoonShadowTexMaterial.RIMMAX);
	}
	set _RimMax(value) {
		this._shaderValues.setNumber(KKCartoonShadowTexMaterial.RIMMAX, value);
	}
	...
	public static initShader(): void {
		...
		var customShader = Laya.Shader3D.add("KKCartoonShadowTexShader");
		var subShader = new Laya.SubShader(attributeMap, uniformMap);
		customShader.addSubShader(subShader);

		

		let pass = subShader.addShaderPass(KKCartoonShadowTexMaterial.vs, KKCartoonShadowTexMaterial.ps);
	...
	constructor() {
		super();
		if (!KKCartoonShadowTexMaterial._inited) {
			KKCartoonShadowTexMaterial.initShader();
			KKCartoonShadowTexMaterial._inited = true;
		}
		this.setShaderName("KKCartoonShadowTexShader");
		this._shaderValues.setVector(KKCartoonShadowTexMaterial.ALBEDOCOLOR, new Laya.Vector4(1.0, 1.0, 1.0, 1.0));
	}
}
