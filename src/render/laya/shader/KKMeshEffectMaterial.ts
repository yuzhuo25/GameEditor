 ...
 * 地面背景shader
 */
export default class KKMeshEffectMaterial extends Laya.BaseMaterial {
    /**渲染状态_不透明。*/
    ...
    /** 默认材质，禁止修改*/
    static defaultMaterial: KKMeshEffectMaterial;

    public static TIME = Laya.Shader3D.propertyNameToID("u_Time");
    public static STARTTIME = Laya.Shader3D.propertyNameToID("u_StartTime");
    ...
    private static vs = `#include "Lighting.glsl";
		...
		void main() {
            ...
            if(u_SpeedX != 0.0 || u_SpeedY != 0.0){
                ...
                v_Texcoord0.x += u_SpeedX*t;
                v_Texcoord0.y += u_SpeedY*t;
            }
 ...
 */
    get _MainTex() {
        return this._shaderValues.getTexture(KKMeshEffectMaterial.ALBEDOTEXTURE);
    }
     ...
     */
    set _MainTex(value) {
        this._shaderValues.setTexture(KKMeshEffectMaterial.ALBEDOTEXTURE, value);
        if (value)
            this._shaderValues.addDefine(KKMeshEffectMaterial.SHADERDEFINE_ALBEDOTEXTURE);
        else
            this._shaderValues.removeDefine(KKMeshEffectMaterial.SHADERDEFINE_ALBEDOTEXTURE);
    }
 ...
 */
    get _Color() {
        return this._shaderValues.getVector(KKMeshEffectMaterial.ALBEDOCOLOR);
    }
     ...
     */
    set _Color(value) {
        this._shaderValues.setVector(KKMeshEffectMaterial.ALBEDOCOLOR, value);
    }
     ...
     */
    get _SpeedX() {
        return this._shaderValues.getNumber(KKMeshEffectMaterial.SPEEDX);
    }
     ...
     */
    set _SpeedX(value) {
        this._shaderValues.setNumber(KKMeshEffectMaterial.SPEEDX, value);
    }
     ...
     */
    get _SpeedY() {
        return this._shaderValues.getNumber(KKMeshEffectMaterial.SPEEDY);
    }
     ...
     */
    set _SpeedY(value) {
        this._shaderValues.setNumber(KKMeshEffectMaterial.SPEEDY, value);
    }
    ...
    set _AlbedoIntensity(value: number) {
        if (this._albedoIntensity !== value) {
            var finalAlbedo: Laya.Vector4 = (<Laya.Vector4>this._shaderValues.getVector(KKMeshEffectMaterial.ALBEDOCOLOR));
            Laya.Vector4.scale(this._albedoColor, value, finalAlbedo);
            this._albedoIntensity = value;
            this._shaderValues.setVector(KKMeshEffectMaterial.ALBEDOCOLOR, finalAlbedo);
        }
    }
    ...
    get _MainTex_STX(): number {
        return this._shaderValues.getVector(KKMeshEffectMaterial.TILINGOFFSET).x;
    }

    set _MainTex_STX(x: number) {
        var tilOff: Laya.Vector4 = (<Laya.Vector4>this._shaderValues.getVector(KKMeshEffectMaterial.TILINGOFFSET));
        tilOff.x = x;
    ...
    get _MainTex_STY(): number {
        return this._shaderValues.getVector(KKMeshEffectMaterial.TILINGOFFSET).y;
    }
    ...
    get _MainTex_STZ(): number {
        return this._shaderValues.getVector(KKMeshEffectMaterial.TILINGOFFSET).z;
    }
    ...
    get _MainTex_STW(): number {
        return this._shaderValues.getVector(KKMeshEffectMaterial.TILINGOFFSET).w;
    }
    ...
    get tilingOffset(): Laya.Vector4 {
        return (<Laya.Vector4>this._shaderValues.getVector(KKMeshEffectMaterial.TILINGOFFSET));
    }

    set tilingOffset(value: Laya.Vector4) {
        if (value) {
            if (value.x != 1 || value.y != 1 || value.z != 0 || value.w != 0)
                this._shaderValues.addDefine(KKMeshEffectMaterial.SHADERDEFINE_TILINGOFFSET);
            else
                this._shaderValues.removeDefine(KKMeshEffectMaterial.SHADERDEFINE_TILINGOFFSET);
        } else {
            this._shaderValues.removeDefine(KKMeshEffectMaterial.SHADERDEFINE_TILINGOFFSET);
        }
        this._shaderValues.setVector(KKMeshEffectMaterial.TILINGOFFSET, value);
    }
    ...
    set enableVertexColor(value: boolean) {
        ...
        if (value)
            this._shaderValues.addDefine(KKMeshEffectMaterial.SHADERDEFINE_ENABLEVERTEXCOLOR);
        else
            this._shaderValues.removeDefine(KKMeshEffectMaterial.SHADERDEFINE_ENABLEVERTEXCOLOR);
    }
    ...
    set renderMode(value: number) {
        switch (value) {
            case KKMeshEffectMaterial.RENDERMODE_OPAQUE:
                ...
                break;
            case KKMeshEffectMaterial.RENDERMODE_CUTOUT:
                ...
                this.depthTest = Laya.RenderState.DEPTHTEST_LESS;
                break;
            case KKMeshEffectMaterial.RENDERMODE_TRANSPARENT:
                ...
                this.depthTest = Laya.RenderState.DEPTHTEST_LESS;
                break;
            case KKMeshEffectMaterial.RENDERMODE_ADDTIVE:
                this.renderQueue = Laya.BaseMaterial.RENDERQUEUE_TRANSPARENT;
                this.depthWrite = false;
                this.cull = Laya.RenderState.CULL_NONE;
                this.blend = Laya.RenderState.BLEND_ENABLE_ALL;
                ...
                break;
            default:
                throw new Error("KKMeshEffectMaterial : renderMode value error.");
        }
    }
    ...
    get depthWrite(): boolean {
        return this._shaderValues.getBool(KKMeshEffectMaterial.DEPTH_WRITE);
    }

    set depthWrite(value: boolean) {
        this._shaderValues.setBool(KKMeshEffectMaterial.DEPTH_WRITE, value);
    }
	 ...
	 */
    get cull(): number {
        return this._shaderValues.getInt(KKMeshEffectMaterial.CULL);
    }

    set cull(value: number) {
        this._shaderValues.setInt(KKMeshEffectMaterial.CULL, value);
    }
	 ...
	 */
    get blend(): number {
        return this._shaderValues.getInt(KKMeshEffectMaterial.BLEND);
    }

    set blend(value: number) {
        this._shaderValues.setInt(KKMeshEffectMaterial.BLEND, value);
    }
	 ...
	 */
    get blendSrc(): number {
        return this._shaderValues.getInt(KKMeshEffectMaterial.BLEND_SRC);
    }

    set blendSrc(value: number) {
        this._shaderValues.setInt(KKMeshEffectMaterial.BLEND_SRC, value);
    }
	 ...
	 */
    get blendDst(): number {
        return this._shaderValues.getInt(KKMeshEffectMaterial.BLEND_DST);
    }

    set blendDst(value: number) {
        this._shaderValues.setInt(KKMeshEffectMaterial.BLEND_DST, value);
    }
    ...
    get depthTest(): number {
        return this._shaderValues.getInt(KKMeshEffectMaterial.DEPTH_TEST);
    }

    set depthTest(value: number) {
        this._shaderValues.setInt(KKMeshEffectMaterial.DEPTH_TEST, value);
    }
    ...
    get _StartTime(): number {
        return this._shaderValues.getNumber(KKMeshEffectMaterial.STARTTIME);
    }

    set _StartTime(value: number) {
        this._shaderValues.setNumber(KKMeshEffectMaterial.STARTTIME, value);
    }
	 ...
	 */
    clone(): any {
        var dest: KKMeshEffectMaterial = new KKMeshEffectMaterial();
        this.cloneTo(dest);
        return dest;
    }
    ...
    public static initShader(): void {
        ...
        KKMeshEffectMaterial.SHADERDEFINE_ALBEDOTEXTURE = Laya.Shader3D.getDefineByName("ALBEDOTEXTURE");
        KKMeshEffectMaterial.SHADERDEFINE_TILINGOFFSET = Laya.Shader3D.getDefineByName("TILINGOFFSET");
        KKMeshEffectMaterial.SHADERDEFINE_ENABLEVERTEXCOLOR = Laya.Shader3D.getDefineByName("ENABLEVERTEXCOLOR");
        ...
        let pass = subShader.addShaderPass(KKMeshEffectMaterial.vs, KKMeshEffectMaterial.ps, stateMap);
    ...
    constructor() {
        super();
        if (!KKMeshEffectMaterial._inited) {
            KKMeshEffectMaterial.initShader();
            KKMeshEffectMaterial._inited = true;

        }
        this.setShaderName("KKMeshEffectShader");
        this._shaderValues.setVector(KKMeshEffectMaterial.ALBEDOCOLOR, new Laya.Vector4(1.0, 1.0, 1.0, 1.0));
        this._shaderValues.setVector(KKMeshEffectMaterial.TILINGOFFSET, new Laya.Vector4(1.0, 1.0, 0.0, 0.0));
        this.renderMode = KKMeshEffectMaterial.RENDERMODE_OPAQUE;
        this._SpeedX = 0;
        this._SpeedY = 0;
        this._StartTime = 0;
